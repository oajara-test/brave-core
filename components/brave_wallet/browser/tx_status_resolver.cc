...
void TxStatusResolver::GetRunningTranactionsCount(
    GetRunningTranactionsCountCallback callback) {
...
void TxStatusResolver::RunCheck(GetRunningTranactionsCountCallback callback,
                                size_t counter,
                                mojom::CoinType coin) {
...
void TxStatusResolver::OnTxResolved(
  ...
  counter += GetInProgressTransactionsCount(result);
...
size_t TxStatusResolver::GetInProgressTransactionsCount(
