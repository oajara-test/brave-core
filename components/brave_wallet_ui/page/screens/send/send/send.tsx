...
export const Send = (props: Props) => {
  ...
  const addressMessageInformation: AddressMessageInfo | undefined = React.useMemo(() => {
    ...
    if (showEnsOffchainLookupOptions) {
      return {
        title: getLocale('braveWalletEnsOffChainLookupTitle'),
        description: getLocale('braveWalletEnsOffChainLookupDescription'),
    ...
    <>
      <SendContainer ref={ref}>
        ...
        <StandardButton
          ...
          buttonType='primary'
          buttonWidth='full'
          isLoading={!showEnsOffchainLookupOptions && searchingForDomain}
          disabled={!showEnsOffchainLookupOptions && isReviewButtonDisabled}
